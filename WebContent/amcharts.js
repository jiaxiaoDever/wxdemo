...
AmCharts.AmChart = AmCharts.Class({
    ...
    drawChart: function() {
        ...
        this.background = f;
        e.push(f);
        if (f = this.backgroundImage) this.path && (f = this.path + f),
        this.bgImg = a = a.image(f, 0, 0, b, d),
        e.push(a);
        this.redrawLabels();
        this.drawTitles()
    },
    drawTitles: function() {
        var a = this.titles;
        if (AmCharts.ifArray(a)) for (var b = 20,
        d = 0; d < a.length; d++) {
            var e = a[d],
            f = e.color;
    ...
    updateWidth: function() {
        ...
        if (d) {
            ...
            0 > a && (a = 0),
            h.width = a + "px",
            "left" == d ? h.left = AmCharts.findPosX(this.div) + f + "px": e.left = a + "px",
            e.top = (b - g) / 2 + "px"
        }
        return a
    },
    getTitleHeight: function() {
        var a = 0,
        b = this.titles;
        if (0 < b.length) for (var a = 15,
        d = 0; d < b.length; d++) a += b[d].size + 6;
        return a
    },
    ...
    addListeners: function() {
        ...
        !0), b.addEventListener("touchstart",
        function(b) {
...
AmCharts.hitTest = function(a, b, d) {
    ...
    e || (e = j(f, i, b));
    e || (e = j(g, h, b));
    e || (e = j(g, i, b)); ! e && !0 != d && (e = AmCharts.hitTest(b, a, !0));
    return e
};
...
AmCharts.Bezier = AmCharts.Class({
    ...
    drawBeziers: function(a) {
        for (var b = "",
        d = 0; d < (a.length - 1) / 3; d++) b += this.drawBezierMidpoint(a[3 * d], a[3 * d + 1], a[3 * d + 2], a[3 * d + 3]);
        return b
    },
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    drawLegend: function() {
        ...
        this.titleWidth = 0;
        if (f = this.title) a = AmCharts.text(this.container, f, this.color, a.fontFamily, this.fontSize, "start", !0),
    ...
    createEntry: function(a) {
        if (!1 !== a.visibleInLegend) {
            ...
            if (h) {
                ...
                i.dItem = a; ! 0 != a.hidden ? "x" == h ? i.hide() : i.show() : "x" != h && i.hide();
    ...
    createMarker: function(a, b, d) {
        ...
        case "triangleDown":
            ...
            break;
        case "bubble":
            g = AmCharts.circle(f, e / 2, b, d, h, b, i, !0),
            g.translate(e / 2, e / 2)
        }
        return g
    },
...
AmCharts.AmCoordinateChart = AmCharts.Class({
    ...
    parseSerialData: function() {
        ...
        for (b = 0; b < a.length; b++) l = a[b],
        l.dataProvider && this.parseGraphData(l)
    },
    ...
    removeGraph: function(a) {
        ...
        d = b.length - 1; 0 <= d; d--) b[d] == a && (b.splice(d, 1), a.destroy());
        this.validateData()
    },
    ...
    unhighlightGraph: function() {
        ...
        if (1 != alpha) for (var a = this.graphs,
...
AmCharts.AmRectangularChart = AmCharts.Class({
    ...
    resetMargins: function() {
        ...
        if ("serial" == this.chartType) {
            ...
            if ((d = this.categoryAxis) && !d.ignoreAxisWidth) d.setOrientation(!this.rotate),
            d.fixAxisPosition(),
            d.fixAxisPosition(),
            a[d.position] = !0
        } else {
    ...
    measureMargins: function() {
        ...
        j = f - d;
        b = g - d;
        for (var k = 0; k < a.length; k++) b = this.getAxisBounds(a[k], h, j, i, b),
        h = b.l,
        j = b.r,
        i = b.t,
        b = b.b;
        if (a = this.categoryAxis) b = this.getAxisBounds(a, h, j, i, b),
        h = b.l,
        j = b.r,
        i = b.t,
        b = b.b;
...
AmCharts.AmSerialChart = AmCharts.Class({
    ...
    drawChart: function() {
        ...
        if (AmCharts.ifArray(a)) {
            ...
            if (d.parseDates && !d.equalSpacing) {
                if (d = this.startTime, e = this.endTime, isNaN(d) || isNaN(e)) d = a[0].time,
                e = a[b].time
            } else if (d = this.start, e = this.end, isNaN(d) || isNaN(e)) d = 0,
            e = b;
    ...
    timeZoom: function(a, b) {
        ...
        if (!isNaN(d) && (b != this.endTime && b - a > d && (a = b - d, this.updateScrollbar = !0), a != this.startTime && b - a > d)) b = a + d,
        this.updateScrollbar = !0;
    ...
    indexZoom: function(a, b) {
        ...
        if (!isNaN(d) && (b != this.end && b - a > d && (a = b - d, this.updateScrollbar = !0), a != this.start && b - a > d)) b = a + d,
        this.updateScrollbar = !0;
    ...
    countColumns: function() {
        ...
        h, i = 0; i < b; i++) {
            ...
            if ("none" == j || "3d" == j) for (h = 0; h < d; h++) e = this.graphs[h],
            !e.hidden && (e.valueAxis == f && "column" == e.type) && (e.columnIndex = a, a++);
            if ("3d" == j) {
                for (i = 0; i < d; i++) e = this.graphs[i],
                e.depthCount = a;
                a = 1
            }
        }
    ...
    getCategoryIndexByValue: function(a) {
        ...
        d, e = 0; e < b.length; e++) b[e].category == a && (d = e);
        return d
    },
...
AmCharts.AxisBase = AmCharts.Class({
    ...
    pushAxisItem: function(a) {
        var b = a.graphics();
        0 < b.length() && this.set.push(b); (a = a.getLabel()) && this.labelsSet.push(a)
    },
    addGuide: function(a) {
        this.guides.push(a)
    },
    removeGuide: function(a) {
        ...
        d = 0; d < b.length; d++) b[d] == a && b.splice(d, 1)
    },
...
AmCharts.ValueAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
            ...
            if (!isNaN(this.min) && !isNaN(this.max) && this.foundGraphs && Infinity != this.min && -Infinity != this.max) {
                ...
                s = !1;
                for (e = m; e < n; e += p) u = AmCharts.roundTo(this.step * e + this.min, d),
                -1 != ("" + u).indexOf("e") && (s = !0, ("" + u).split("e"));
                this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
                for (e = m; e < n; e += p) if (m = this.step * e + this.min, m = AmCharts.roundTo(m, this.maxDecCount + 1), !(this.integersOnly && Math.round(m) != m)) { ! 0 == i && (0 == m && (m = this.minReal), 2 < q && (m = Math.pow(10, e)), s = -1 != ("" + m).indexOf("e") ? !0 : !1);
            ...
            a = this.labelsSet;
            this.positionTitle();
            "radar" != j ? (j = this.viX, f = this.viY, b.translate(j, f), a.translate(j, f)) : i.toFront(); ! this.visible || h ? (b.hide(), i.hide(), a.hide()) : (b.show(), i.show(), a.show())
        }
    },
    stackGraphs: function(a) {
        ...
        l,
        o = this.baseValue;
        if (("line" == a || "step" == a || "smoothedLine" == a) && ("regular" == b || "100%" == b)) for (l = 0; l < i.length; l++) h = i[l],
        h.hidden || (k = h.type, h.chart == this.chart && (h.valueAxis == this && a == k && h.stackable) && (j && (h.stackGraph = j), j = h));
        ...
        for (j = this.start; j <= this.end; j++) for (l = 0; l < i.length; l++) h = i[l],
        ...
        for (var d, e = a; e <= b; e++) {
            ...
            for (g in f) {
                ...
                if (h.includeInMinMax && (!h.hidden || this.includeHidden)) {
                    ...
                    var i;
                    if (this.minMaxField) i = h[this.minMaxField],
                    i < d && (d = i);
...
AmCharts.CategoryAxis = AmCharts.Class({
    ...
    draw: function() {
        ...
        if (AmCharts.ifArray(a)) {
            ...
            for (g = 0; g < this.data.length; g++) if (i = this.data[g]) j = this.parseDates && !this.equalSpacing ? Math.round((i.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(g - f),
            i.x[this.id] = j
        }
        i = this.guides.length;
        for (g = 0; g < i; g++) j = this.guides[g],
        m = h = d = NaN,
        j.toCategory && (m = b.getCategoryIndexByValue(j.toCategory), isNaN(m) || (d = this.getCoordinate(m - f), k = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, j), this.pushAxisItem(k))),
        j.category && (m = b.getCategoryIndexByValue(j.category), isNaN(m) || (h = this.getCoordinate(m - f), m = (d - h) / 2, k = new this.axisItemRenderer(this, h, j.label, !0, NaN, m, j), this.pushAxisItem(k))),
        j.toDate && (this.equalSpacing ? (m = b.getClosestIndex(this.data, "time", j.toDate.getTime(), !1, 0, this.data.length - 1), isNaN(m) || (d = this.getCoordinate(m - f))) : d = (j.toDate.getTime() - this.startTime) * this.stepWidth, k = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, j), this.pushAxisItem(k)),
        j.date && (this.equalSpacing ? (m = b.getClosestIndex(this.data, "time", j.date.getTime(), !1, 0, this.data.length - 1), isNaN(m) || (h = this.getCoordinate(m - f))) : h = (j.date.getTime() - this.startTime) * this.stepWidth, m = (d - h) / 2, k = "H" == this.orientation ? new this.axisItemRenderer(this, h, j.label, !1, 2 * m, NaN, j) : new this.axisItemRenderer(this, h, j.label, !1, NaN, m, j), this.pushAxisItem(k)),
        d = new this.guideFillRenderer(this, h, d, j),
        h = d.graphics(),
        this.pushAxisItem(d),
        j.graphics = h,
        h.index = g,
        j.balloonText && this.addEventListeners(h, j);
        this.axisCreated = !0;
        b = this.x;
        f = this.y;
        this.set.translate(b, f);
        this.labelsSet.translate(b, f);
        this.positionTitle(); (b = this.axisLine.set) && b.toFront()
    },
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, d, e, f, g, h, i, j) {
        ...
        ca = R.getBBox().width;
        if ("H" == U) {
            if (0 <= b && b <= $ + 1 && (0 < s && (0 < r && b + j <= $ + 1) && (ba = AmCharts.line(p, [b + j, b + j], [0, s], q, r, w), m.push(ba)), 0 < t)) L = AmCharts.line(p, [b, b + K, b + K], [da, da + E, E], x, t, w, C),
            m.push(L);
            v = 0;
            B = b;
            h && 90 == D && (B -= l); ! 1 == e ? (L = "start", v = "bottom" == J ? I ? v + s: v - s: I ? v - s: v + s, B += 3, f && (B += f / 2, L = "middle"), 0 < D && (L = "middle")) : L = "middle";
            ...
            if (R && (J = 0, I && (J = ca * Math.cos(Q)), E + J > $ + 1 || 0 > E)) R.remove(),
            R = null
        } else {
            if (0 <= b && b <= da + 1 && (0 < s && (0 < r && b + j <= da + 1) && (ba = AmCharts.line(p, [0, s], [b + j, b + j], q, r, w), m.push(ba)), 0 < t)) L = AmCharts.line(p, [0, K, $ + K], [b, b + E, b + E], x, t, w, C),
            m.push(L);
            L = "end";
            ...
            I = -3;
            "right" == J && (I += E);
            if (R && (v > da + 1 || v < I)) R.remove(),
            R = null
        }
        ba && ba.translate(ea, ga); ! 1 == a.visible && (ba && ba.remove(), R && (R.remove(), R = null));
        R && (R.attr({
            "text-anchor": L
...
AmCharts.RadItem = AmCharts.Class({
    construct: function(a, b, d, e, f, g, h) {
        ...
        b = a.y - b;
        if ("polygons" == u) {
            for (var K = [], E = [], U = a.data.length, d = 0; d < U; d++) i = 180 - 360 / U * d,
            K.push(b * Math.sin(i / 180 * Math.PI)),
            E.push(b * Math.cos(i / 180 * Math.PI));
            K.push(K[0]);
            E.push(E[0]);
        ...
        if (1 == f && 0 < w && !h) {
            h = a.previousCoord;
            if ("polygons" == u) {
                for (d = U; 0 <= d; d--) i = 180 - 360 / U * d,
                K.push(h * Math.sin(i / 180 * Math.PI)),
                E.push(h * Math.cos(i / 180 * Math.PI));
...
AmCharts.RadarFill = AmCharts.Class({
    construct: function(a, b, d, e) {
        ...
        if ("polygons" == a.gridType) {
            for (var e = [], j = [], k = a.data.length, l = 0; l < k; l++) i = 180 - 360 / k * l,
            e.push(f * Math.sin(i / 180 * Math.PI)),
            j.push(f * Math.cos(i / 180 * Math.PI));
            e.push(e[0]);
            j.push(j[0]);
            for (l = k; 0 <= l; l--) i = 180 - 360 / k * l,
            e.push(b * Math.sin(i / 180 * Math.PI)),
            j.push(b * Math.cos(i / 180 * Math.PI));
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createXYGraph: function() {
        ...
        for (var f = this.start; f <= this.end; f++) {
            ...
            j = h.y,
            h = d.getCoordinate(i),
            k = e.getCoordinate(j); ! isNaN(i) && !isNaN(j) && (a.push(h), b.push(k), (i = this.createBullet(g, h, k, f)) || (i = 0), this.labelText && (g = this.createLabel(g, h, k), this.positionLabel(h, k, g, this.labelPosition, i)))
        }
    ...
    createRadarGraph: function() {
        ...
        b = [], d = [], e, f, g = this.start; g <= this.end; g++) {
            ...
            d = [];
                ...
                b.push(i);
                d.push(j); (k = this.createBullet(h, i, j, g)) || (k = 0);
    ...
    createSerialGraph: function() {
        ...
        r,
        s,
        t = this.chart.graphs.length,
        w,
        x = this.dx / this.depthCount,
        ...
        for (M = N; M <= D; M++) {
            ...
            if (ma) {
                ...
                case "line":
                    ...
                    else if (O < E && (v.isNegative = !0), n.push(z), q.push(y), V = z, W = y, qa = z, ra = y, Qa) ja.push(X),
                    ka.push(S);
                    break;
                case "smoothedLine":
                    ...
                    if (!isNaN(O)) {
                        ...
                        if (ia) {
                            ...
                            if (!T) {
                                ...
                                if ("regular" == u || "100%" == u) A = "middle",
                                w = l ? 0 < ma.value ? (this.end + 1 - M) * t + b: (this.end + 1 - M) * t - b: 0 < ma.value ? t * M + b: t * M - b;
                ...
                case "candlestick":
                    if (!isNaN(ha) && !isNaN(Sa) && !isNaN(Ra) && !isNaN(O)) {
                        ...
                        if (ia && (na = ia.set, aa.push(na), na.translate(H, G), v.url && na.setAttr("cursor", "pointer"), La && (aa.push(La), aa.push(Ua)), V = z, W = y, qa = z, ra = y, !T)) v.x = l ? G + F / 2 : H + F / 2,
                        this.animateColumns(ia, M, z, X, y, S),
                        this.addListeners(na, v)
                    }
                    break;
                    ...
                    if (this.end - this.start <= lb || 0 == lb) {
                        ...
                        if (this.labelText) {
                            ...
                            if (fa) if (V += ta, W += Aa, fa.translate(V, W), l) {
                                if (0 > W || W > j) fa.remove(),
                                fa = null
                            } else if (0 > V || V > i) fa.remove(),
                            fa = null
                        }
                    }
                }
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(n, q, ja, ka) : this.drawLineGraph(n, q, ja, ka),
    ...
    drawLineGraph: function(a, b, d, e) {
        if (1 < a.length) {
            ...
            if (0 < f && (j = a.join(";").split(";"), k = b.join(";").split(";"), "serial" == this.chartType && (0 < d.length ? (d.reverse(), e.reverse(), j = a.concat(d), k = b.concat(e)) : this.rotate ? (k.push(k[k.length - 1]), j.push(q), k.push(k[0]), j.push(q), k.push(k[0]), j.push(j[0])) : (j.push(j[j.length - 1]), k.push(q), j.push(j[0]), k.push(q), j.push(a[0]), k.push(k[0]))), a = AmCharts.polygon(g, j, k, o, f, 0, 0, 0, this.gradientRotation), h.push(a), m || void 0 != p)) n || (n = f),
            m || (m = p),
            g = AmCharts.polygon(g, j, k, m, n, 0, 0, 0, this.gradientRotation),
            i.push(g);
            this.applyMask(i, h)
        }
    },
    ...
    drawSmoothedGraph: function(a, b) {
        if (1 < a.length) {
            ...
            if (0 < j && (h = "", this.rotate ? (h += " L" + m + "," + b[b.length - 1], h += " L" + m + "," + b[0]) : (h += " L" + a[a.length - 1] + "," + m, h += " L" + a[0] + "," + m), h += " L" + a[0] + "," + b[0], k = new AmCharts.Bezier(e, a, b, NaN, 0, 0, k, j, d, h), f.push(k.path), o || void 0 != l)) p || (p = j),
            o || (o = l),
            e = new AmCharts.Bezier(e, a, b, NaN, 0, 0, o, p, d, h),
            g.push(e.path);
            this.applyMask(g, f)
        }
    },
    ...
    createBullet: function(a, b, d) {
        ...
        if (this.customBullet || a.customBullet) if (f = this.customBullet, a.customBullet && (f = a.customBullet), f) i && i.remove(),
        "function" == typeof f ? (i = new f, i.chart = this.chart, a.bulletConfig && (i.availableSpace = d, i.graph = this, a.bulletConfig.minCoord = this.minCoord - d, i.bulletConfig = a.bulletConfig), i.write(e), i = i.set) : (this.chart.path && (f = this.chart.path + f), i = e.image(f, 0, 0, g, g).attr({
            preserveAspectRatio: !0
        }), this.centerCustomBullets && (b -= g / 2, d -= g / 2));
        if (i) {
            a.url && i.setAttr("cursor", "pointer");
            this.allBullets.push(i);
            if ("serial" == this.chartType && (0 > b || b > this.width || d < -g / 2 || d > this.height)) i.remove(),
            i = null;
    ...
    showBullets: function() {
        for (var a = this.allBullets,
        b = 0; b < a.length; b++) a[b].show()
    },
    hideBullets: function() {
        for (var a = this.allBullets,
        b = 0; b < a.length; b++) a[b].hide()
    },
    addListeners: function(a, b) {
        var d = this;
        a.mouseover(function() {
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    updateCrosshair: function() {
        ...
        this.zooming && this.updateSelectionSize(b, d); ! a.mouseIsOver && !this.zooming && this.hideCursor()
    },
    updateSelectionSize: function(a, b) {
        ...
        h = this.width,
        i = this.height;
        if (!isNaN(a) && (d > a && (f = a, h = d - a), d < a && (f = d, h = a - d), d == a)) f = a,
        h = 0;
        if (!isNaN(b) && (e > b && (g = b, i = e - b), e < b && (g = e, i = b - e), e == b)) g = b,
        i = 0;
        ...
        if (this.enabled) {
            ...
            if (d.mouseIsOver || u || A || this.forceShow) if (this.forceShow = !1, A) {
                ...
                if (N && this.valueBalloonsEnabled && t && d.balloon.enabled) {
                    ...
                    T, t = 0; t < N.length; t++) r = N[t],
                    r.showBalloon && (!r.hidden && r.balloonText) && (s = p.axes[r.valueAxis.id].graphs[r.id], w = s.y, isNaN(w) || (n ? Math.abs(e - w) < h && (h = Math.abs(e - w), T = r) : Math.abs(f - w) < h && (h = Math.abs(f - w), T = r)));
    ...
    handleMouseUp: function() {
        ...
        if (this.enabled) {
            if (this.pan) this.rolledOver = !1;
                ...
                a.chart = this.chart;
                if ("cursor" == this.type) {
                    if (this.rotate ? this.selectionPosY = d: this.selectionPosX = d = b, !(2 > Math.abs(d - this.initialMouse) && this.fromIndex == this.index)) this.index < this.fromIndex ? (a.end = this.fromIndex, a.start = this.index) : (a.end = this.index, a.start = this.fromIndex),
                    d = this.chart.categoryAxis,
                    d.parseDates && !d.equalSpacing && (a.start = this.data[a.start].time, a.end = this.data[a.end].time),
...
AmCharts.line = function(a, b, d, e, f, g, h, i, j) {
    ...
    isNaN(f) || (g["stroke-opacity"] = f);
    e && (g.stroke = e);
    for (var e = Math.round,
    f = AmCharts.dx,
    h = AmCharts.dy,
    i = "M" + (e(b[0]) + f) + "," + (e(d[0]) + h), k = 1; k < b.length; k++) i += " L" + (e(b[k]) + f) + "," + (e(d[k]) + h);
...
AmCharts.AmPieChart = AmCharts.Class({
    ...
    drawChart: function() {
        ...
        if (AmCharts.ifArray(b)) {
            ...
            for (l = 0; l < b.length; l++) if (f = b[l], !0 != f.hidden && 0 < f.percents) {
                ...
                a.graphsSet.push(i); (0 == f.alpha || 0 < d && !a.chartCreated) && i.hide();
    ...
    drawTicks: function() {
        for (var a = this.chartData,
        b = 0; b < a.length; b++) if (this.chartDataLabels[b]) {
            var d = a[b],
            e = d.ty,
            f = this.radiusReal,
    ...
    checkOverlapping: function(a, b, d, e, f) {
        ...
        if (k) {
            ...
            else for (h = a - 1; 0 <= h; h--)(g = this.checkOverlappingReal(b, i[h], d)) && (h = 0); ! 0 == g && 100 > f && (g = b.ty + 3 * b.iy, b.ty = g, k.translate(b.tx2, g), this.checkOverlapping(a, b, d, e, f + 1))
        }
    },
    ...
    startSlices: function() {
        for (var a = this,
        b = 500 * (a.startDuration / a.chartData.length), d = 0; d < a.chartData.length; d++) if (0 < a.startDuration && a.sequencedAnimation) {
    ...
    pullInAll: function(a) {
        for (var b = this.chartData,
        d = 0; d < this.chartData.length; d++) d != a && b[d].pulled && this.pullSlice(b[d], 0)
    },
    pullOutAll: function() {
        for (var a = this.chartData,
    ...
    parseData: function() {
        ...
        if (void 0 != b) {
            ...
            f = 0; f < d; f++) {
                ...
                i || (i = "");
                g.title = i;
                g.pulled = AmCharts.toBoolean(h[this.pulledField], !1); (i = h[this.descriptionField]) || (i = "");
                g.description = i;
    ...
    recalculatePercents: function() {
        ...
        b = 0,
        d = 0; d < a.length; d++) {
            var e = a[d]; ! e.hidden && 0 < e.value && (b += e.value)
        }
...
AmCharts.AmXYChart = AmCharts.Class({
    ...
    zoomScrollbars: function() {
        ...
        a && a.relativeZoom(this.widthMultiplyer, -this.horizontalPosition / this.widthMultiplyer); (a = this.scrollbarV) && a.relativeZoom(this.heightMultiplyer, -this.verticalPosition / this.heightMultiplyer)
    },
...
AmCharts.AmDObject = AmCharts.Class({
    ...
    push: function(a) {
        if (a) {
            ...
            var d = a.clipPath;
            d && b.appendChild(d); (d = a.grad) && b.appendChild(d);
    ...
    updateAnimations: function() {
        for (var a = this.animations.length - 1; 0 <= a; a--) {
            ...
            if (e <= d) {
                ...
                g = "transform",
                b = "translate(" + j + "," + b + ")";
                else h = Number(b.from),
                j = Number(b.to),
                j -= h,
                b = this.D[b.effect](0, e, h, j, d),
                0 == j && this.animations.splice(a, 1);
                this.setAttr(f, g, b)
            } else "translate" == g ? (i = b.to.split(","), j = Number(i[0]), i = Number(i[1]), f.translate(j, i)) : (j = Number(b.to), this.setAttr(f, g, j)),
            this.animations.splice(a, 1)
        }
    },
    getBBox: function(a) {
